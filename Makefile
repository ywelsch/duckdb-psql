...
EXTENSION_FLAGS=-DDUCKDB_OOT_EXTENSION_NAMES="psql" -DDUCKDB_OOT_EXTENSION_PSQL_PATH="$(PROJ_DIR)" -DDUCKDB_OOT_EXTENSION_PSQL_SHOULD_LINK="TRUE" -DDUCKDB_OOT_EXTENSION_PSQL_INCLUDE_PATH="$(PROJ_DIR)src/include"
